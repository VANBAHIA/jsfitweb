...
function ContaReceberDetalhes({ conta, onRegistrarPagamento, onFechar }) {
        ...
        <div className={`p-6 border-b flex items-center justify-between bg-gradient-to-r from-${statusColor}-600 to-${statusColor}-700`}>
          <div className="flex items-center gap-3">
            ...
            <div className="text-white">
              <h3 className="text-2xl font-bold">Conta a Receber #{conta.numero}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div className="bg-gray-50 rounded-lg p-4">
                <h4 className="text-sm font-semibold text-gray-600 mb-3">📋 DADOS DA CONTA</h4>
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">{conta.aluno?.pessoa?.nome1 || 'N/A'}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Matrícula:</span>
                    <span className="font-semibold">{conta.aluno?.matricula || 'N/A'}</span>
                  </div>
                  <div className="flex justify-between">
            ...
            <div className="space-y-4">
              <div className="bg-green-50 rounded-lg p-4">
                <h4 className="text-sm font-semibold text-green-600 mb-3">💰 VALORES</h4>
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center pt-2 border-t border-green-200">
                    ...
                    <span className="font-bold text-xl text-green-700">{formatarMoeda(conta.valorFinal)}</span>
                  </div>
              ...
              {conta.formaPagamento && (
                <div className="bg-purple-50 rounded-lg p-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-semibold">{conta.formaPagamento.replace('_', ' ')}</span>
                  </div>
                </div>
              )}
            </div>
...
export default ContaReceberDetalhes;